...
namespace JaGunma.Chikusan.Loading
{
    /// <summary>
    ...
    {
        private static System.Drawing.Color _color = System.Drawing.ColorTranslator.FromHtml("#2196F3");
        ...
        private static readonly DependencyProperty _ringFillProperty =
            DependencyProperty.Register("RingFill", typeof(Brush), typeof(LoadingRingBase),
                ...
                //new UIPropertyMetadata(new SolidColorBrush(Color.FromRgb(33, 150, 243)),
                new UIPropertyMetadata(new SolidColorBrush(Color.FromRgb(255, 82, 82)),
